      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-3xl mx-auto prose prose-slate">
          <p className="text-lg mb-4">
            Welcome to Minimalist, where simplicity meets elegance. We believe in the power of minimalist design and high-quality products that enhance your everyday life.
          </p>
          <p className="mb-4">
          ...
          <p>
            Thank you for choosing Minimalist. We're excited to be part of your journey towards a more intentional lifestyle.
          </p>
        </div>
      </main>
    </>
